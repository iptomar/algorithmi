 ...
 */
public class Min extends CoreElement {

    public static String symbol = FkeyWord.get("FUNCTION.min");
    public static String help = FkeyWord.get("FUNCTION.min.help");
    public static String definition = FkeyWord.get("FUNCTION.min.definition");
    ...
    protected Fsymbol execute(Fsymbol[] p) throws FlowchartException {
        if (p[0] instanceof Finteger && p[1] instanceof Finteger) {
            ...
            return new Finteger((int) Math.min(p0, p1));
        }
        if (p[0] instanceof FabstractNumber && p[1] instanceof FabstractNumber) {
            ...
            return new Freal(Math.min(p0, p1));
        }
...
//            lst.add(new Flogic(true));
    ...
    //TOKEN OF CALCULATOR
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    public static String TOKEN = FkeywordToken.get("FUNCTION.min.key");
