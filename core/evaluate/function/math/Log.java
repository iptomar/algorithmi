 ...
 */
public class Log extends CoreElement {

    public static String symbol = FkeyWord.get("FUNCTION.log");
    public static String help = FkeyWord.get("FUNCTION.log.help");
    public static String definition = FkeyWord.get("FUNCTION.log.definition");
    ...
    protected Fsymbol execute(Fsymbol[] p) throws FlowchartException {
        ...
        if (p[0] instanceof FabstractNumber) {
            ...
            return new Freal(Math.log10(p0));
        }
...
//            lst.add(new Logic(false));
    ...
    //TOKEN OF CALCULATOR
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    public static String TOKEN = FkeywordToken.get("FUNCTION.log.key");
