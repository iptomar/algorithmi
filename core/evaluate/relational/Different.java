 ...
 */
public class Different extends CoreElement {

    public static String symbol = FkeyWord.get("OPERATOR.different");
    public static String help = FkeyWord.get("OPERATOR.different.help");
    public static String definition = symbol;

    public Different() {
        super(2, PRIORITY_RELATIONAL);
    }
    ...
    protected Fsymbol execute(Fsymbol[] p) throws FlowchartException {
        ...
        if (p[0] instanceof Flogic && p[1] instanceof Flogic) {
            Boolean v = ((Boolean) p[0].getValue()).compareTo((Boolean) p[1].getValue()) != 0;
            return new Flogic(v);
        }
...
//            lst.add(new Flogic(false));
    ...
    //TOKEN OF CALCULATOR
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    public static String TOKEN = FkeywordToken.get("OPERATOR.different.key");
