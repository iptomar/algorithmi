 ...
 * @author ZULU
 */
public class DefineShape extends BorderFlowChart {
     ...
     */
    public DefineShape(Color color) {
        super(color);
    }
    ...
    public void paint(Graphics g, int x, int y, int width, int height, Color fillColor) {
        ...
        g2.drawLine(x + getBorderSize(), y, x + getBorderSize(), y + height);
//        g.drawLine(x + width - getThickness(), y, +width - getThickness(), y + height);
        g2.drawLine(x, y + getBorderSize(), x + width, y + getBorderSize());
//        g.drawLine(x, y + height - getThickness(), x + width, y + height - getThickness());
    }
