 ...
 * @author ZULU
 */
public class ReturnShape extends BorderFlowChart {
     ...
     */
    public ReturnShape(Color color) {
        super(color);
    }
    ...
    public Insets getBorderInsets(Component c, Insets insets) {
        ...
        insets.set(FProperties.BORDER_SIZE, FProperties.BORDER_SIZE * 3, FProperties.BORDER_SIZE, FProperties.BORDER_SIZE * 3);
        return insets;
    }
