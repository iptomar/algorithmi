 ...
 * @author ZULU
 */
public class JumpShape extends BorderFlowChart {
    ...
    public Insets getBorderInsets(Component c, Insets insets) {
        insets.set(FProperties.BORDER_SIZE, FProperties.BORDER_SIZE + getBorderSize(), FProperties.BORDER_SIZE, FProperties.BORDER_SIZE + getBorderSize());
        return insets;
    }
