 ...
 * @author ZULU
 */
public final class ArrowLL_IF extends Arrow {

    public ArrowLL_IF(Fshape begin, Fshape end) {
        super(new ShapeArrowLL(FProperties.arrowColor), begin, end);
        setLink(begin, end);
    }
    ...
    public void updatePosition() {
        int x0 = parent.getX() - border.getBorderSize() * 2;
    ...
    protected Dimension getPreferedDimension() {
        if (parent != null && next != null) {
            ...
            return new Dimension(width, height + BorderFlowChart.getThickness() * 2);
