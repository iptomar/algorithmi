 ...
 * @author ZULU
 */
public final class ArrowRT extends Arrow {

    public ArrowRT(Fshape begin, Fshape end) {
        super(new ShapeArrowRT(FProperties.arrowColor), begin, end);
        setLink(begin, end);
    }
    ...
    protected Dimension getPreferedDimension() {
        if (parent != null && next != null) {
            int w = next.getX() + next.getWidth() / 2 - parent.getX() - parent.getWidth() + BorderFlowChart.getThickness() ;
