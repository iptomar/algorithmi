 ...
 */
public class Or extends CoreElement {

    public static String symbol = FkeyWord.get("OPERATOR.or");
    public static String help = FkeyWord.get("OPERATOR.or.help");
    public static String definition = symbol;

    public Or() {
        super(2, PRIORITY_LOGIC);
    }
    ...
    //TOKEN OF CALCULATOR
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    public static String TOKEN = FkeywordToken.get("OPERATOR.or.key");
