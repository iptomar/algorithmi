 ...
 */
public class LessOrEqual extends CoreElement {

    public static String symbol = FkeyWord.get("OPERATOR.lessOrEqual");
    public static String help = FkeyWord.get("OPERATOR.lessOrEqual.help");
    ...
    public Flogic compare(Fsymbol n1, Fsymbol n2) throws FlowchartException {
        return (Flogic) execute(new Fsymbol[]{n1, n2});
    }
    ...
    public static void main(String[] args) {
        LessOrEqual calc = new LessOrEqual();
        try {
...
//            lst.add(new Flogic(false));
    ...
    //TOKEN OF CALCULATOR
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    public static String TOKEN = FkeywordToken.get("OPERATOR.lessOrEqual.key");
