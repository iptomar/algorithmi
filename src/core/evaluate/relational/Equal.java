 ...
 */
public class Equal extends CoreElement {

    public static String symbol = FkeyWord.get("OPERATOR.equal");
    public static String help = FkeyWord.get("OPERATOR.equal.help");
