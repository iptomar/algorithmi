 ...
 */
public class Sqrt extends CoreElement {

    public static String symbol = FkeyWord.get("FUNCTION.sqrt");
    public static String help = FkeyWord.get("FUNCTION.sqrt.help");
    public static String definition = FkeyWord.get("FUNCTION.sqrt.definition");
    ...
    protected Fsymbol execute(Fsymbol[] p) throws FlowchartException {
        ...
        if (p[0] instanceof FabstractNumber) {
            ...
            if (p0 < 0) {
                throw new FlowchartException("FUNCTION.error.sqrtNegative",
                        getSymbol(),
                        getSymbol() + Mark.ROUND_OPEN + p[0].getDefinitionValue() + Mark.ROUND_CLOSE
                );
            }
            return new Freal(Math.sqrt(p0));
        }
    ...
    //TOKEN OF CALCULATOR
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    public static String TOKEN = FkeywordToken.get("FUNCTION.sqrt.key");
