...
//    List<SingleMemoryDisplay> lst = new ArrayList<>();
    GraphExecutor program;
...
//        this.lst = lst;
    ...
    public void createMemory() {
        if (program != null) {
            createMemory(program.getProgramMemory());
        }
    }
