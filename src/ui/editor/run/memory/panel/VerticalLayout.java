...
/**
 * Created on 30/abr/2016, 13:04:40
 *
 ...
 * <p>
 */
public class VerticalLayout implements LayoutManager, java.io.Serializable {
     ...
     * <code>VerticalLayout.TOP</code>,
     * <code>VerticalLayout.BOTTOM</code> or
     * <code>VerticalLayout.CENTER</code>,
     *
     ...
     * <ul>
     * <li><code>VerticalLayout.TOP</code>
     * <li><code>VerticalLayout.BOTTOM</code>
     * <li><code>VerticalLayout.CENTER</code>
     * </ul>
     *
     ...
     * this <code>VerticalLayout</code> object.
     *
    ...
    private void moveComponents(
        ...
        for (int i = columnStart; i < columnEnd; i++) {
            ...
            if (m.isVisible()) {
                int cx;
                cx = x ;//+ (width - m.getSize().width) / 2; //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: LEFT JUSTIFY
    ...
    /**
     * Returns a string representation of this <code>VerticalLayout</code>
    ...
    public static void main(String[] args) {
        ...
        final JPanel buttons = new JPanel(new VerticalLayout());
//      buttons.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                buttons.add(new JButton("button R Us" + i++));
                else
                     buttons.add(new JTextArea("wedasds\nuygiljhjlhlkhljhlhlkhlhhuhiuhuu\niyghihiuh\n"));
                buttons.revalidate();
//              pack();
            }
        });
