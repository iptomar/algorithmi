 ...
 */
/**
 * Created on 8/set/2015, 16:15:47
 * http://stackoverflow.com/questions/8196530/java-vertical-flowlayout-with-horizontal-scrolling
 * camickr
 *
...
public class VerticalFlowLayout implements LayoutManager, java.io.Serializable {
    ...
    private void moveComponents(
        ...
        for (int i = columnStart; i < columnEnd; i++) {
            Component m = target.getComponent(i);
            //  m.setSize(width, m.getHeight()); //MANSO - same width to all components
            if (m.isVisible()) {
                int cx = hgap;//------------------------------MANSO-----------
