 ...
 * @author ZULU
 */
public class ReadShape extends BorderFlowChart {
    ...
    public void paint(Graphics g, int x, int y, int width, int height, Color color) {
        ...
        int h2 = getBorderSize() * 3 + 1;

        p.addPoint(x + h2, y);
        p.addPoint(x + width, y);
        p.addPoint(x + width - h2, y + height);
    ...
    public Insets getBorderInsets(Component c, Insets insets) {
        insets.set(FProperties.BORDER_SIZE,
                getBorderSize() * 3 + FProperties.BORDER_SIZE, FProperties.BORDER_SIZE,
                getBorderSize() * 3 + FProperties.BORDER_SIZE);
        return insets;
    }
