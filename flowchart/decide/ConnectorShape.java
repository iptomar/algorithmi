 ...
 * @author ZULU
 */
public class ConnectorShape extends BorderFlowChart {
     ...
     */
    public ConnectorShape(Color color) {
        super(color);
    }
...
//        g.setColor(Shape.BACKGROUND_COLOR);
//        g.fillRect(x, y, width, height);
    ...
    public Insets getBorderInsets(Component c, Insets insets) {
        int S = getThickness();
        insets.set(FProperties.BORDER_SIZE+S,
                FProperties.BORDER_SIZE+S,
                FProperties.BORDER_SIZE+S,
                FProperties.BORDER_SIZE+S);
        return insets;
    }
