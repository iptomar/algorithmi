 ...
 * @author ZULU
 */
public class WriteShape extends BorderFlowChart {
    ...
    public Insets getBorderInsets(Component c, Insets insets) {
        insets.set(FProperties.BORDER_SIZE,
                getThickness() * 3+FProperties.BORDER_SIZE, FProperties.BORDER_SIZE, FProperties.BORDER_SIZE);
        return insets;
    }
